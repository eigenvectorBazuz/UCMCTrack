...
class Detector:
    ...
    # results from an offline detector run and/or merge and fusion of several detectors:
    def load_offline_dets(results):
        self.offline_dets = results
        

    def get_dets(self, fr_id, conf_thresh = 0):
        ...
        resutls = self.offline_dets[fr_id]
